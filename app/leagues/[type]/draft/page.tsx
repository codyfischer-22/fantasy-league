...
'(If there are 100 players in the league, we would need 400 unique castaways to draft. With 21 real-life castaways, they would each be cloned 20 times to make 420 draftable league castaways.)',
        ...
        '➤ In the draft window noted above, Fischer Fantasy Leagues will use rankings to simulate a snake draft.',
...
'➤ Private league hosts are responsible for manually starting the live snake draft.',
      ...
      '➤ If a draft pick timer runs out, that player\u2019s pick is skipped and moved to the end of the live draft.',
      '➤ Depending on settings, private league hosts may need to officially confirm each pick.',
      '➤ If the live draft is not completed by the window above, league hosts or Fischer Fantasy Leagues ensure all players have 4 castaways on their tribe. Players failing to adhere to draft procedures outlined by the league host are unable to petition the castaways they receive.',
      '➤ Players that sign up for a private league should expect their hosts to properly communicate and implement all draft policies and deadlines. Fischer Fantasy Leagues is not responsible for issuing refunds if private league hosts fail to perform their expected duties. That is to say, before joining a league, make sure you trust the host to lead responsibly throughout the league.',
    ],
    trades: [
