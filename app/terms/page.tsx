    ...
    <main style={{
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{ color: '#a0a0b0', fontSize: '0.95rem', lineHeight: '1.5' }}>
          ...
          <p>
            You must be at least 18 years old to create an account, join a league, or purchase a
            paid membership tier. By signing up, you confirm that the information you provide
            (including your date of birth) is accurate.
          </p>

          <h2 style={{ color: '#f0b429', fontSize: '1.0rem', marginTop: '12px', marginBottom: '0px' }}>
            3. Membership Tiers & Billing
          </h2>
          <p>
            Paid membership tiers (Castaway, Crew Chief, Team Principal) are billed as recurring
            monthly subscriptions. Your card will be charged automatically each month until you
            cancel. If a payment fails or your subscription is canceled before the end of a 
            particular league, your account will automatically be downgraded to the free Stowaway
            tier. Being downgraded to the free tier will affect your participation in certain group
            features like public league chats or anayltics, but it will be more detrimental to any 
            private leagues you are hosting (which cannot run without their active host). There are
            no free trials, no partial refunds for unused time in a billing period, and no mid-season
            downgrades that allow you to keep membership perks. You may cancel your subscription at 
            any time; your paid access continues through the end of the billing period you&apos;ve 
            already paid for.
          </p>
          ...
          <p>
            ...
            deciding whether you trust that league&apos;s host to run it responsibly.
          </p>

          <h2 style={{ color: '#f0b429', fontSize: '1.0rem', marginTop: '12px', marginBottom: '0px' }}>
            5. Private League Hosting
          </h2>
          <p>
            As noted above, hosting a private league requires an active Crew Chief or Team Principal 
            subscription. If a host&apos;s subscription lapses or is downgraded to Stowaway, their
            private league activity—including but not limited to draft activity, scoring, and trades— 
            will be suspended and unplayable. Both the host and their league members will be notified
            when this occurs to ensure transparency and encourage renewed participation. Full hosting 
            access and league activity resume as early as administrators can accommodate if the host 
            re-upgrades their membership tier to Crew Chief or Team Principal.
          </p>
          ...
          <h2 style={{ color: '#f0b429', fontSize: '1.0rem', marginTop: '12px', marginBottom: '0px' }}>
  8. League Chat & Community Conduct
</h2>
<p>
...
We do not claim ownership of Survivor, NASCAR, F1, or any other underlying television property,
 and nothing in these terms grants you the player any rights to that content either.
          ...
          <p>
            ...
            chat functionality, manipulate drafts or trades through collusion or multiple accounts,
            or otherwise disrupt fair and safe play for other players.
          </p>
...
<p>
  ...
  as they arrive and eliminate bugs in our platform for the betterment of the league experiences.
</p>
...
<p>
  ...
  conflict-of-law principles.
          ...
          <p>
            Reach out via our contact link with any questions about these terms.
          </p>
